(() => {
    ...
    function initSliders() {
        if (document.querySelector(".body-main__slider")) new swiper_core_Swiper(".body-main__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".slider-box__slider")) new swiper_core_Swiper(".slider-box__slider", {
        ...
        if (document.querySelector(".lifehack__slider")) new swiper_core_Swiper(".lifehack__slider", {
            modules: [ Navigation, Pagination, Parallax ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
